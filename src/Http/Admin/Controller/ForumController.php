...
{
    protected string $templatePath = 'forums/tag';
    protected string $menuItem = 'forum';
    ...
    {
        $tag = (new Tag())->setCreatedAt(new \DateTime())->setAuthor($this->getUser());
     ...
     *
     */
    #[Route('forum-tag/position', name: 'forum-tag-positions', methods: ['POST'])]
