 ...
 */
final class Version20210809014902 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE blog_category (id SERIAL NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, color VARCHAR(255) DEFAULT \'#000000\' NOT NULL, online BOOLEAN DEFAULT \'false\' NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, posts_count INT DEFAULT 0 NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE mod (id INT NOT NULL, category_id INT DEFAULT NULL, brand_id INT DEFAULT NULL, credit_id INT DEFAULT NULL, approuveby_id INT DEFAULT NULL, reason_id INT DEFAULT NULL, version VARCHAR(255) DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, console BOOLEAN DEFAULT \'false\' NOT NULL, server BOOLEAN DEFAULT \'false\' NOT NULL, cgu BOOLEAN DEFAULT \'false\' NOT NULL, statut SMALLINT DEFAULT 0 NOT NULL, approuve SMALLINT DEFAULT 0 NOT NULL, accept_admin BOOLEAN DEFAULT \'false\' NOT NULL, approuve_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, detail VARCHAR(255) DEFAULT NULL, url_of_mod VARCHAR(255) DEFAULT NULL, rejet_time INT DEFAULT NULL, no_errors BOOLEAN DEFAULT \'false\' NOT NULL, slug VARCHAR(255) DEFAULT NULL, info BOOLEAN DEFAULT \'false\' NOT NULL, power VARCHAR(255) DEFAULT NULL, price VARCHAR(255) DEFAULT NULL, wheel VARCHAR(255) DEFAULT NULL, grandeur VARCHAR(255) DEFAULT NULL, champs VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
