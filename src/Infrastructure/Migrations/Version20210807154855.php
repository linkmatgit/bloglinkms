 ...
 */
final class Version20210807154855 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mod (id INT NOT NULL, creator_id INT DEFAULT NULL, category_id INT DEFAULT NULL, brand_id INT DEFAULT NULL, approuveby_id INT DEFAULT NULL, reason_key VARCHAR(255) DEFAULT NULL, version VARCHAR(255) DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, console BOOLEAN DEFAULT \'false\' NOT NULL, statut SMALLINT DEFAULT 0 NOT NULL, approuve SMALLINT DEFAULT 0 NOT NULL, accept_admin BOOLEAN DEFAULT \'false\' NOT NULL, approuve_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, detail VARCHAR(255) DEFAULT NULL, url_of_mod VARCHAR(255) DEFAULT NULL, rejet_time INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE mods_category (id SERIAL NOT NULL, author_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, position INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, online BOOLEAN DEFAULT \'false\' NOT NULL, mods_count INT DEFAULT 0 NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE week_mods DROP CONSTRAINT FK_A964FD4A272149B7');
        $this->addSql('ALTER TABLE week_mods DROP CONSTRAINT FK_A964FD4A3594E659');
        $this->addSql('ALTER TABLE week_mods DROP CONSTRAINT FK_A964FD4A8D28813C');
        $this->addSql('ALTER TABLE week_mods DROP CONSTRAINT FK_A964FD4A10FFB985');
        $this->addSql('ALTER TABLE week_mods DROP CONSTRAINT FK_A964FD4AA843DEE0');
        $this->addSql('ALTER TABLE week_mods DROP CONSTRAINT FK_A964FD4ABAF6710E');
        $this->addSql('ALTER TABLE week_mods DROP CONSTRAINT FK_A964FD4A24A166B');
        $this->addSql('ALTER TABLE week_mods DROP CONSTRAINT FK_A964FD4A5A29063D');
        $this->addSql('ALTER TABLE week_mods DROP CONSTRAINT FK_A964FD4AE2956158');
        $this->addSql('ALTER TABLE week_mods DROP CONSTRAINT FK_A964FD4A3BF24D90');
        ...
        $this->addSql('ALTER TABLE week_mods DROP CONSTRAINT FK_A964FD4AF675F31B');
